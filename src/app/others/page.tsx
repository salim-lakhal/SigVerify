        ...
        <section className={styles.section}>
          <div className={styles.content}>
            ...
            <div className={styles.card}>
              ...
              <p>
                Sig Verify will help keep your documents, signatures, and identity safe.
                <a href="#" aria-label="Sign up to learn more">Sign up to learn more.</a>
              </p>
          ...
          <div className={styles.imageContainer}>
            <Image src="/contract.png" alt="Digital signature illustration" width={600} height={400} />
          </div>
        </section>
