			...
			<div className={styles.container}>
				<div className={styles.document}>
					...
					<div className={styles.body}>
						<div className={styles.section}>
							...
							>Description: Successfully design and implement a project utilizing the XRP Ledger, showcasing its capabilities and potential applications.</p>
							<p className={`${styles.initials} ${styles.p}`}>Ambassador Initials:</p>
							<p className={`${styles.initials} ${styles.p}`}>Administrator Initials:</p>
						</div>
						<div className={styles.section}>
				...
				<div className={styles.document}>
					...
					<div className={styles.section}>
						...
						<p className={`${styles.initials} ${styles.p}`}>Signature: <span className={styles.s1}></span> Date:</p>
					</div>
				</div>
			</div>
		</div >
